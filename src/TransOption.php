...
trait TransOption
{
    public static  $waitResult;

    public static  $timeoutToFail;
     ...
     * @var string[]
     */
    public static  $passthroughHeaders = [];

    public static  $branchHeaders = [];

    public static function isWaitResult()
    {
    ...
    public static function getTimeoutToFail()
    {
    ...
    public static function getRetryInterval()
    {
    ...
    public static function getPassthroughHeaders()
    {
    ...
    public static function getBranchHeaders()
    {
